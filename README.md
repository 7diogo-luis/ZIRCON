...
2. **Installer** (complexity: 1) - ZIRCON will have an installer so the program files are kept on a safe directory. The user launches ZIRCON through a shortcut and selects the location for exporting generated files
